...
export const LandingPage: React.FC<LandingPageProps> = ({
  ...
  // Cooperative transparent split: 88% worker, 8% welfare, 4% platform operations
  ...
  const handleHeroSearch = (e: React.FormEvent) => {
    ...
    } else if (q.includes('appl') || q.includes('ac') || q.includes('fridge') || q.includes('wash') || q.includes('ro')) {
  ...
  // 4 Core Category Cards with Realistic Baseline Pricing
  const categoryTiles = [
    {
      id: 'portal:plumbing',
      title: lang === 'hi' ? 'नलसाजी सेवाएं' : 'Plumbing Services',
      hindiTitle: 'नलसाजी एवं स्वच्छता',
      price: '₹750',
      icon: PlumbingIcon,
      color: '#0284c7',
      bgLight: '#f0f9ff',
      tag: 'Pipe leaks, taps, pumps & drains',
      tagHi: 'पाइप लीकेज, नल, मोटर व ड्रेन',
    },
    {
      id: 'portal:electrical',
      title: lang === 'hi' ? 'विद्युत सेवाएं' : 'Electrical Services',
      hindiTitle: 'विद्युत व वायरिंग',
      price: '₹850',
      icon: ElectricalIcon,
      color: '#d97706',
      bgLight: '#fffbeb',
      tag: 'Short circuits, wiring, switches & fans',
      tagHi: 'शॉर्ट सर्किट, वायरिंग, स्विच व पंखे',
    },
    {
      id: 'portal:carpentry',
      title: lang === 'hi' ? 'बढ़ईगीरी सेवाएं' : 'Carpentry Services',
      hindiTitle: 'काष्ठशिल्प व बढ़ईगीरी',
      price: '₹850',
      icon: CarpentryIcon,
      color: '#b45309',
      bgLight: '#fef3c7',
      tag: 'Locks, doors, furniture & modular repairs',
      tagHi: 'ताले, दरवाजे, फर्नीचर व मरम्मत',
    },
    {
      id: 'portal:appliances',
      title: lang === 'hi' ? 'उपकरण मरम्मत' : 'Appliance Repair',
      hindiTitle: 'एसी, फ्रिज व वॉशिंग मशीन',
      price: '₹799',
      icon: ApplianceIcon,
      color: '#4f46e5',
      bgLight: '#eef2ff',
      tag: 'Split AC jet wash, fridge, RO & washing machines',
      tagHi: 'एसी जेट सर्विस, फ्रिज, आरओ व मशीन',
    },
  ];

  // Popular Services Grid with honest cooperative details
  const popularServices = [
    {
      id: 'portal:plumbing',
      title: lang === 'hi' ? 'कंसील्ड पाइपलाइन व लीकेज रिपेयर' : 'Concealed Pipeline & Leakage Repair',
      society: 'Delhi Metropolitan Plumbers Cooperative',
  ...
  return (
    <div className="landing-page">
        ...
        <div className="container">
          <div className="row align-items-center g-4">
            <div className="col-12 col-lg-7">
              <div className="d-inline-flex align-items-center gap-1 badge bg-primary-subtle text-primary border border-primary-subtle mb-3 px-3 py-2 rounded-pill">
                <ShieldCheckIcon size={14} color="var(--ux4g-primary, #4a2bc2)" />
                <span className="fw-semibold">
                  {lang === 'hi' ? 'विश्वसनीय सहकारी कारीगर नेटवर्क' : 'Community-Powered Home Services'}
                </span>
              </div>
              ...
              <p className="lead text-secondary mb-4" style={{ fontSize: '1.05rem', lineHeight: 1.6 }}>
                {lang === 'hi'
              ...
              {/* Large Search Box */}
              <form onSubmit={handleHeroSearch} className="card p-2 border shadow-sm mb-4 bg-white rounded-3">
                  ...
                  return (
                    <div key={cat.id} className="col-6">
                      ...
                      >
                        ...
                        <div className="small text-muted mb-2" style={{ fontSize: '0.75rem', lineHeight: 1.3 }}>
                          {lang === 'hi' ? cat.tagHi : cat.tag}
                        </div>
                        <div className="mt-auto d-flex justify-content-between align-items-center pt-2 border-top">
                          <span className="small text-muted" style={{ fontSize: '0.72rem' }}>Starting</span>
                          <span className="fw-bold text-primary" style={{ fontSize: '0.9rem' }}>{cat.price}</span>
                        </div>
                      </div>
                    </div>
                  );
      ...
      {/* ==========================================================================
          2. POPULAR SERVICES WITH TRANSPARENT PRICING
          ========================================================================== */}
      <section className="py-5" id="services">
        <div className="container">
          <div className="d-flex justify-content-between align-items-end mb-4 flex-wrap gap-2">
            <div>
              <span className="small text-primary fw-bold text-uppercase tracking-wider">
                {lang === 'hi' ? 'मानकीकृत सेवाएं' : 'Standardized Home Repairs'}
              </span>
                ...
                <div key={index} className="col-12 col-md-6 col-lg-4">
                  <div className="card h-100 border shadow-xs p-3 bg-white d-flex flex-column" style={{ borderRadius: '12px' }}>
                    <div className="d-flex justify-content-between align-items-start mb-2">
                      <div
                        className="p-2 rounded-circle bg-light border text-primary d-flex align-items-center justify-content-center"
                    ...
                    <p className="small text-secondary mb-3 flex-grow-1" style={{ fontSize: '0.82rem', lineHeight: 1.4 }}>
                      {service.desc}
                    </p>

                    <div className="d-flex align-items-center gap-3 mb-3 small text-muted" style={{ fontSize: '0.75rem' }}>
                      <span className="d-inline-flex align-items-center gap-1">
                        <ClockIcon size={12} />
                    ...
                    <div className="mt-auto pt-2 border-top d-flex justify-content-between align-items-center">
                      <div>
                        ...
                        <div className="text-muted" style={{ fontSize: '0.68rem' }}>Labour only · Spares extra</div>
                      </div>
      ...
      <section className="py-5 bg-light border-top border-bottom">
        <div className="container">
          <div className="text-center mb-5" style={{ maxWidth: '640px', margin: '0 auto' }}>
            <span className="small text-primary fw-bold text-uppercase tracking-wider">
              {lang === 'hi' ? 'विश्वास एवं सुरक्षा' : 'Trust & Protection'}
            </span>
            <h2 className="h3 fw-bold text-dark mt-1 mb-2">
            ...
            {trustPillars.map((tp, idx) => {
              ...
              return (
                <div key={idx} className="col-12 col-sm-6 col-lg-3">
                  <div className="card h-100 border shadow-xs p-4 bg-white text-center" style={{ borderRadius: '12px' }}>
                    <div
                    ...
                    <p className="small text-muted mb-0" style={{ fontSize: '0.82rem', lineHeight: 1.5 }}>
                      {tp.desc}
                    </p>
                  </div>
                </div>
      ...
      <section className="py-5" id="calculator">
        <div className="container">
          <div className="card border shadow-sm p-4 p-md-5 bg-white" style={{ borderRadius: '16px' }}>
            <div className="row align-items-center g-4">
              <div className="col-12 col-lg-6">
                <span className="small text-primary fw-bold text-uppercase tracking-wider">
                  {lang === 'hi' ? 'पारदर्शी सहकारिता मॉडल' : 'Fair To Workers · Fair To You'}
                </span>
                <h2 className="h3 fw-bold text-dark mt-1 mb-3">
                ...
                <div className="row g-3">
                  <div className="col-12">
                    <div className="p-3 rounded-3 border bg-success-subtle border-success-subtle d-flex justify-content-between align-items-center">
                      <div>
                        <div className="small fw-bold text-success text-uppercase" style={{ fontSize: '0.72rem' }}>
                          88% Direct Payout
                        </div>
                  ...
                  <div className="col-12">
                    <div className="p-3 rounded-3 border bg-primary-subtle border-primary-subtle d-flex justify-content-between align-items-center">
                      <div>
                        <div className="small fw-bold text-primary text-uppercase" style={{ fontSize: '0.72rem' }}>
                          8% Cooperative Fund
                        </div>
                        <div className="fw-semibold text-dark">
                        ...
                        <div className="text-muted small" style={{ fontSize: '0.72rem' }}>
                          Administered democratically by the primary cooperative society
                        </div>
                      </div>
                  ...
                  <div className="col-12">
                    <div className="p-3 rounded-3 border bg-light d-flex justify-content-between align-items-center">
                      <div>
                        <div className="small fw-bold text-secondary text-uppercase" style={{ fontSize: '0.72rem' }}>
      ...
      <section className="py-5 bg-light border-top">
        <div className="container">
          <div className="text-center mb-5" style={{ maxWidth: '640px', margin: '0 auto' }}>
            <span className="small text-primary fw-bold text-uppercase tracking-wider">
              {lang === 'hi' ? 'समुदाय' : 'Community Portals'}
            </span>
            <h2 className="h3 fw-bold text-dark mt-1 mb-2">
              ...
              <div key={p.id} className="col-12 col-md-4">
                ...
                >
                  ...
                  <div className="card-body p-4 d-flex flex-column flex-grow-1">
                    <span className="badge bg-light text-primary border align-self-start mb-2" style={{ fontSize: '0.72rem' }}>
                      {p.badge}
                    </span>
